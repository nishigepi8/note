---
title: 自研 P2P 服务的架构之路
description: 在物联网和实时通信领域，P2P（点对点）连接是实现低延迟、高质量音视频传输的关键技术。然而，很多团队在起步阶段会选择依赖第三方 WebRTC 服务，随着业务规模扩大，逐渐会遇到以下痛点：
author: ga666666
date: 2026-01-10
updated: 2026-01-10
...
```mermaid
flowchart LR
    A[App / 设备发起会话] --> B[MQTT 信令交换 Offer/Answer]
    B --> C[STUN 探测 NAT 类型]
    C --> D{是否可直连}
    D -->|是| E[P2P 直连传输媒体]
    D -->|否| F[TURN 中继转发]
