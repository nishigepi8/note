---
title: AI协作基础设施专题
description: 聚合 MCP、AGENTS 规则、Skill、端到端协作标准、工作流模式、团队网关收口与团队记忆中枢，讨论团队怎样把 AI 协作从零散使用升级为稳定的工程基础设施。
author: ga666666
date: 2026-04-22
updated: 2026-09-17
keywords: AI 协作, MCP, AGENTS.md, Skill, 上下文工程, 工程化, Agent Memory
...
- [团队记忆中枢：TencentDB Agent Memory 架构与实践](./团队记忆中枢：TencentDB%20Agent%20Memory%20架构与实践.md)
  - 适合理解规范收口之后，团队的经验和知识怎么被沉淀、共享和复用

## 这个专题的边界

这个专题只收“偏工程落地”的文章，不把所有 AI 方法论文章都混进来。目前 7 篇，按能力分层排列。
