...
| 文章 | 关键词 | 难度 |
|------|--------|------|
| [P2P、SFU和MCU音视频通信架构](/post/音视频/P2P、SFU和MCU音视频通信架构.md) | 架构对比、扩展性、成本分析 | ⭐⭐⭐ |
| [RTP 实时传输协议](/post/音视频/RTP%20实时传输协议.md) | 协议头、时间戳、序列号、RTCP | ⭐⭐⭐⭐ |
| [WebRTC 信令服务详解](/post/音视频/WebRTC%20信令服务详解.md) | SDP、ICE、Offer/Answer、信令 | ⭐⭐⭐ |
| [Luckfox Pico Max P2P直播方案](/post/音视频/Luckfox%20Pico%20Max%20P2P直播方案.md) | 嵌入式、H.264、NAT穿透、Pion | ⭐⭐⭐⭐ |
