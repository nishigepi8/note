---
title: 嵌入式设备的 P2P 直播实践
description: 最近入手了 Luckfox Pico Max 这块小开发板，基于 Rockchip RV1106 芯片，性价比很高，特别适合做一些边缘端的视频项目。我的目标是实现一个真正的点对点（P2P）视频直播方案：摄像头采集的视频能直接从一台设备传到另一台设备，尽量不依赖中心服务器，只在必要时用中继。这样既省流量，又低延迟，...
author: ga666666
date: 2026-01-10
updated: 2026-01-10
...
```mermaid
flowchart LR
    A[RV1106 摄像头采集] --> B[C 模块硬编码 H.264]
    B --> C[Golang 模块封装与发送]
    C --> D[信令交换与 NAT 穿透]
    D --> E{网络条件}
    E -->|可穿透| F[P2P 直连播放]
