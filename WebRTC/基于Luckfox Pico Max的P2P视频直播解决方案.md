# 用 Luckfox Pico Max 实现低成本 P2P 视频直播方案
...
（典型 WebRTC P2P 连接流程，包括 STUN/TURN）
...
这个方案成本低（板子不到 100 元）、灵活性强，适合 DIY 监控、远程查看等场景。如果你也在玩 Luckfox 或类似嵌入式视频项目，欢迎交流，一起优化！